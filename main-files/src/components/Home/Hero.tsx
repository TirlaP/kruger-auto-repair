      ...
      >
         ...
         <div className="flex h-full w-full flex-col items-center justify-center font-header text-default">
            ...
            >
               ...
               <br />
               <span className="text-primary">SUBA</span>
               <span className="text-tertiary">RU</span>
            </MotionH1>
            <div className="flex items-center gap-x-2 md:gap-x-4">
               ...
               >
                  <span className="text-end">22 YEARS OF</span>
                  <span className="text-end">EXPERIENCE</span>
               </MotionP>
               <MotionH1
                  variants={{
                     offscreen: { opacity: 0, y: 100 },
