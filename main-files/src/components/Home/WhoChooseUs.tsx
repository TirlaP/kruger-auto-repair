   ...
   return (
      <section className="overflow-hidden bg-[#12151B] bg-[url('/images/bg-1.svg')] bg-cover">
         ...
         >
            ...
            >
               <FanFactCard footnote="years experience" title="22+" />
            </MotionDiv>
            <MotionDiv
               variants={{
                  offscreen: { opacity: 0, x: 200 },
            ...
            >
               <FanFactCard footnote="subaru head gaskets completed" title="500+" />
            </MotionDiv>
            <MotionDiv
               variants={{
                  offscreen: { opacity: 0, x: 200 },
            ...
            >
               <FanFactCard footnote="vehicles serviced" title="10K+" />
            </MotionDiv>
         </MotionDiv>
      </section>
   );
