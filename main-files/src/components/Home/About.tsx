      ...
      <MotionSection className="overflow-hidden bg-background-dark bg-[url('/images/bg-1.svg')] bg-cover py-6 sm:py-12 lg:py-[150px]">
         <div className="container grid gap-y-5 px-5 font-header md:gap-y-10 lg:grid-cols-2 lg:gap-x-10 2xl:gap-x-12 2xl:px-0">
            ...
            >
               ...
               >
                  For the last 22 years, John Kruger has been performing quality auto repairs and regular maintenance 
                  services for satisfied customers throughout Salt Lake City and surrounding communities. John decided 
                  in 2003 to create a new standard for automotive service along the Wasatch Front, inspiring confidence, 
                  trust, and fairness. We specialize in Honda, Toyota, and Subaru vehicles from 2006 to current models.
               </MotionP>
               ...
               >
                  <p className="text-xs font-extrabold uppercase text-default-foreground sm:text-sm md:text-base xl:text-lg">
                     &quot;We strive to gain confidence in our customers with great service, 
                     high-integrity professionals, and honest repairs.&quot;
                  </p>
